...
- [What is BioDockify Studio?](#what-is-biodockifystudio)
...
│   └── package.json
├── public/
├── docker-compose.yml         # Base: biodockifystudio + rtmp-relay
├── docker-compose.vps.yml     # VPS: + Ollama
├── docker-compose.full.yml    # Full: biodockifystudio + Ollama + RTMP relay
